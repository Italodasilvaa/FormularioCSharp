...
namespace Formulario_Novo.Models
{
    public class SaveViewModel
    {
        ...
        public SaveViewModel(int idCliente, string id_estado, string nome, DateTime dataNascimento, List<SelectListItem> linguagens, string sexo, List<SelectListItem> estado, string mensagem)
        {
            IdCliente = idCliente;
            Id_estado = id_estado;
            Nome = nome;
